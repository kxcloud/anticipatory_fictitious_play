...
for filepath in filenames:
    ...
    #%% Empirical game
    fig, ax = plt.subplots()
    pc = ax.pcolormesh(payoff_matrices[4], #.mean(axis=0), 
    ...
    plot_utils.plot_with_confidence(ax, x=range(1,population_size), data=-all_exploitability["afp"], c="C1", label="AFP", lw=2, alpha=ALPHA)
